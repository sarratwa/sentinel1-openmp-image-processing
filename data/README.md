...
Die weitere Vorbereitung erfolgt anschließend mit dem Python-Skript `scripts/prepare_tiff.py`. Dabei wird die TIFF-Datei in ein einfaches 16-bit-PGM-Graustufenbild konvertiert, das vom C/OpenMP-Programm gelesen werden kann.
